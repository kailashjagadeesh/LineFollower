...
while(interrupt_count90 > counter_left && interrupt_count90> counter_right)
  {
  if(counter_right <interrupt_count90)
    analogWrite(pwm_pin1,255 );
  else
    stop();
  if(counter_left < interrupt_count90)
